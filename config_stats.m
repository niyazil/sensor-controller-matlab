...
Rthetax=[rhox1*sqrt(varx(1)*varTheta)+meanx(1)*meanTheta;
         rhox2*sqrt(varx(1)*varTheta)+meanx(2)*meanTheta;
     ...
     if length(pos)==7
         Rthetax=[Rthetax;rhox7*sqrt(varx(7)*varTheta)+meanx(7)*meanTheta];
     end
...
if(length(pos)==6)
    ...
    Rx=[varx(1)+meanx(1)^2 correlMat(1,2)*sqrt(varx(1)*varx(2))+meanx(1)*meanx(2) correlMat(1,3)*sqrt(varx(1)*varx(3))+meanx(1)*meanx(3) correlMat(1,4)*sqrt(varx(1)*varx(4))+meanx(1)*meanx(4) correlMat(1,5)*sqrt(varx(1)*varx(5))+meanx(1)*meanx(5) correlMat(1,6)*sqrt(varx(1)*varx(6))+meanx(1)*meanx(6);
        ...
        correlMat(3,1)*sqrt(varx(3)*varx(1))+meanx(3)*meanx(1)	correlMat(3,2)*sqrt(varx(3)*varx(2))+meanx(3)*meanx(2)	varx(3)+meanx(3)^2 correlMat(3,4)*sqrt(varx(3)*varx(4))+meanx(3)*meanx(4) correlMat(3,5)*sqrt(varx(3)*varx(5))+meanx(3)*meanx(5) correlMat(3,6)*sqrt(varx(3)*varx(6))+meanx(3)*meanx(6);
        correlMat(4,1)*sqrt(varx(4)*varx(1))+meanx(4)*meanx(1)	correlMat(4,1)*sqrt(varx(4)*varx(2))+meanx(4)*meanx(2)	correlMat(4,3)*sqrt(varx(4)*varx(3))+meanx(4)*meanx(3)	varx(4)+meanx(4)^2 correlMat(4,5)*sqrt(varx(4)*varx(5))+meanx(4)*meanx(5) correlMat(4,6)*sqrt(varx(4)*varx(6))+meanx(4)*meanx(6);
        correlMat(5,1)*sqrt(varx(5)*varx(1))+meanx(5)*meanx(1)	correlMat(5,2)*sqrt(varx(5)*varx(2))+meanx(5)*meanx(2)	correlMat(5,3)*sqrt(varx(5)*varx(3))+meanx(5)*meanx(3)	correlMat(5,4)*sqrt(varx(5)*varx(4))+meanx(5)*meanx(4)	varx(5)+meanx(5)^2 correlMat(5,6)*sqrt(varx(5)*varx(6))+meanx(5)*meanx(6);
        correlMat(6,1)*sqrt(varx(6)*varx(1))+meanx(6)*meanx(1)	correlMat(6,2)*sqrt(varx(6)*varx(2))+meanx(6)*meanx(2)	correlMat(6,3)*sqrt(varx(6)*varx(3))+meanx(6)*meanx(3)	correlMat(6,4)*sqrt(varx(6)*varx(4))+meanx(6)*meanx(4)	correlMat(6,5)*sqrt(varx(6)*varx(5))+meanx(6)*meanx(5)	varx(6)+meanx(6)^2];
    ...
    Rx=[varx(1)+meanx(1)^2 correlMat(1,2)*sqrt(varx(1)*varx(2))+meanx(1)*meanx(2) correlMat(1,3)*sqrt(varx(1)*varx(3))+meanx(1)*meanx(3) correlMat(1,4)*sqrt(varx(1)*varx(4))+meanx(1)*meanx(4) correlMat(1,5)*sqrt(varx(1)*varx(5))+meanx(1)*meanx(5) correlMat(1,6)*sqrt(varx(1)*varx(6))+meanx(1)*meanx(6) correlMat(1,7)*sqrt(varx(1)*varx(7))+meanx(1)*meanx(7);
        ...
        correlMat(4,1)*sqrt(varx(4)*varx(1))+meanx(4)*meanx(1)	correlMat(4,1)*sqrt(varx(4)*varx(2))+meanx(4)*meanx(2)	correlMat(4,3)*sqrt(varx(4)*varx(3))+meanx(4)*meanx(3)	varx(4)+meanx(4)^2 correlMat(4,5)*sqrt(varx(4)*varx(5))+meanx(4)*meanx(5) correlMat(4,6)*sqrt(varx(4)*varx(6))+meanx(4)*meanx(6) correlMat(4,7)*sqrt(varx(4)*varx(7))+meanx(4)*meanx(7);
