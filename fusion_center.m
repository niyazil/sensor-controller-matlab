...
fileName='C:\Users\Zumerjud\Desktop\Dropbox\sensorReadings.xls';
...
%to make sure scanned off beacons are not counted in vector of received
%measurements
y=x(1:length(indices));

%actual estimate
theta=Rthetax_Alg'*inv(Rx_Alg)*y;