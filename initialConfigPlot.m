...
%read positions
    ...
    scatter(sourcePos(1),sourcePos(2),150,'MarkerEdgeColor','k','MarkerFaceColor','y','LineWidth',1)
    scatter(FCPos(1),FCPos(2),80,'MarkerEdgeColor','k','MarkerFaceColor','g','LineWidth',1)
